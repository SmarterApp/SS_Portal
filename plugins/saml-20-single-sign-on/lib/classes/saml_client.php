...
class SAML_Client
{
  ...
  public function authenticate()
  {
    ...
    else
    {
      ...
      // BEGIN Smarter Balanced modification:
      // Create a cookie for rest of WP to access the SAML respone
      // May want to consider sending this only over https, but need to set up https first.
      // WARNING: Most browsers limit the cookie size to just under 4K.
      ...
      // END Smarter Balanced modification

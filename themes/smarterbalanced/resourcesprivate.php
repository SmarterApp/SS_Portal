<?php
/*
Template Name: Private Resources
*/
?>
...
<?php if ( is_user_logged_in() ) { ?>
	<div class="resourcesWrapper clear">
       ...
       <?php $tax='private-resource-group';
	   ...
	   if ( $count > 0 ){ ?>
            	...
            	<ul class="jump">
                    ...
                    <?php } ?>
                       ...
                       <?php $group = $term->slug; query_posts( array( 'post_type' => 'resource', 'resource-group' => $group, 'secure' => 'private', 'posts_per_page' => -1  ) );
	   ...
	   <?php }else{ ?>     
                       ...
                       <?php query_posts( array( 'post_type' => 'resource', 'secure' => 'private', 'posts_per_page' => -1  ) );
							 if ( have_posts() ) : while ( have_posts() ) : the_post(); $published_posts++;?>                   
                            <tr>
                                    <td><?php 
